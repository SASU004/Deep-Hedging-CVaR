...
type LabInsightsPanelProps = {
  insights: Insight[];
};

export function LabInsightsPanel({ insights }: LabInsightsPanelProps) {
  return (
    <Section variant="secondary" id="lab-insights">
      <SectionHeader
        eyebrow="Section 6"
        title="Lab insights panel"
        description="Live observations synthesized from your controls — updates as parameters move."
      />
      ...
      <Card padding="lg" className="border-accent/15">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted">Auto-generated from simulator state</p>
          </div>
        </div>
